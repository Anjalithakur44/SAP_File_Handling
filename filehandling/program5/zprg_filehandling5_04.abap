...
DATA: lv_afile(30) TYPE c VALUE '/usr/sap/A4H/SYS/src/order.txt'.
...
IF sy-subrc = 0.
  LOOP AT lt_data INTO lwa_data.
    CONCATENATE lwa_data-ono lwa_data-odate lwa_data-pm lwa_data-ta INTO lv_string SEPARATED BY ' '.
